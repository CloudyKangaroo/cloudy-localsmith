...
exports.findByClientID = function(clientID, done) {
  var _ = require('underscore');
  var returnList = _.findWhere(contacts, {clientID: clientID});
  return done(null, returnList);
};

exports.findByUsername = function(username, done) {
  var _ = require('underscore');
  var returnList = _.find(contacts, {username: username});
  return done(null, returnList);
};

exports.findByEmail = function(email, done) {
  var _ = require('underscore');
  var returnList = _.find(contacts, {email: email});
  return done(null, returnList);
};

exports.findByName = function(name, done) {
  var _ = require('underscore');
  var returnList = _.find(contacts, {name: name});
  return done(null, returnList);
};
